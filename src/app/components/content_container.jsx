...
import HelpCentre from './helpcentre/help_centre';
import LivechatDemo from './helpcentre/livechat-demo';
				...
				<Layout.Content>
					<nav className="navbar navbar-light bg-faded">
						<ul className="navbar-nav" >
							<li className="nav-item" ><Link className="n-link" to="helpcentre" >articles</Link></li>
							<li className="nav-item" ><Link className="n-link" to="livechat-demo" >livechat demo</Link></li>
						</ul>
					</nav>
					{this.props.children}
				</Layout.Content>
